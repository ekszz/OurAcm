...
function reFresh() {
	...
	.done(function(data) {
		...
		$.each(data.data, function(i, vo) {
			reshtml = reshtml + '<tr><td><label style="padding-right:15px"><input type="checkbox" id="' + vo.aid + '" data-id="id"></label></td><td>' + vo.aid + '</td>';
			...
			reshtml = reshtml + '</td><td class="text-center inline"><div class="btn-group" id="table-toolbar-operate"><a data-aid="' + vo.aid + '" data-func="0" data-target="#activity-modal" data-toggle="modal" class="btn btn-xs btn-default" title="查看" data-trigger="hover"><span class="glyphicon glyphicon-zoom-in"></span></a><a data-aid="' + vo.aid + '" data-func="2" data-target="#activity-modal" data-toggle="modal" class="btn btn-xs btn-default" title="编辑" data-trigger="hover" data-placement="bottom"><span class="glyphicon glyphicon-pencil"></span></a><a data-toggle="del_activity" data-aid="' + vo.aid + '" class="btn btn-xs btn-default" title="删除"><span class="glyphicon glyphicon-remove"></span></a></div></td></tr>';  
		});
